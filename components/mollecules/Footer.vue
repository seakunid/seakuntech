<template>
  <div class="footer lg:pt-6 xl:pt-12 mt-12 bg-[#2d2d2d]">
    <div
      class="tn:px-3 md:!container !text-[#EFEFEF] !text-sm p-4 md:grid md:grid-cols-2 md:justify-between lg:grid-cols-5 lg:gap-8 lg:justify-center"
    >
