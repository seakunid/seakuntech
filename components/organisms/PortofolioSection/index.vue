<template>
  <div class="pt-8 pb-6 lg:pb-8 text-center bg-gradient">
    <h2 class="tn:text-[20px] md:text-[30px] xl:text-[36px] font-bold">
...
<style>
.bg-gradient {
  background: linear-gradient(175.34deg, #ffffff 3.77%, #f2fffc 96.23%);
}
</style>
